...
var repository = data_source_1.AppDataSource.getRepository(Tasks_1.Tasks);
...
var saveTask = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var task;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, repository.save(request.body)];
            case 1:
                task = _a.sent();
...
var getTask = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var id, task;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = request.params.id;
                return [4 /*yield*/, repository.findOneBy({ id: parseInt(id) })];
            case 1:
                task = _a.sent();
                return [2 /*return*/, response.json(task)];
        }
...
var updateTask = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = request.params.id;
                return [4 /*yield*/, repository.update(id, request.body)];
            case 1:
                task = _a.sent();
            ...
            case 3: return [2 /*return*/, response.status(404).json({ message: "Tarefa não encontrada!" })];
        }
    });
}); };
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (task.affected == 1) {
                    ...
                    return [2 /*return*/, response.status(404).json({ message: "Tarefa não encontrada!" })];
                }
                return [2 /*return*/];
        }
    });
...
var finishedTask = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var id, task, taskFinished;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = request.params.id;
                return [4 /*yield*/, repository.update(id, {
                        finished: true,
                    })];
            case 1:
                task = _a.sent();
                ...
                return [4 /*yield*/, repository.findOneBy({ id: parseInt(id) })];
            case 2:
                taskFinished = _a.sent();
                return [2 /*return*/, response.json(taskFinished)];
            case 3: return [2 /*return*/, response.status(404).json({ message: "Tarefa não encontrada!" })];
        }
    });
}); };
